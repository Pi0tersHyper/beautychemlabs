        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="group relative bg-white-50 border border-white-300 rounded-lg overflow-hidden hover:border-teal-500 transition-all duration-300 hover:shadow-md hover:shadow-teal-500/10"
              >
                ...
                <div className="p-4 sm:p-5">
                  ...
                  <a
                    href="#contact"
                    className="mt-3 sm:mt-4 inline-block text-[10px] sm:text-xs font-semibold text-teal-600 hover:text-teal-700 tracking-widest uppercase transition-colors"
                  >
                    {"Zapytaj o cenę →"}
                  </a>
                </div>
